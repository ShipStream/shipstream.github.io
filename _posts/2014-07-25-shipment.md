...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Total Weight" property.  The units are the same as the shipment's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
        <th>total_qty</th>
    ...
    <tr>
        ...
        <td>
            ...
            The "Shipped Weight" property. The units are the same as the shipment's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
...
<tr>
    ...
    <td>
        ...
        The unit of measure used for the package weight.
    </td>
</tr>
<tr>
    ...
    <td>
        ...
        The billable weight of the package. The units are the same as the shipment's <code>weight_unit</code> property.
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        ...
        The dimensional weight of the package.  The units are the same as the shipment's <code>weight_unit</code> property.
    </td>
</tr>
<tr>
    <th>dimensions</th>
