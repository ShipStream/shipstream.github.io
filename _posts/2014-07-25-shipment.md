...
```json
{
    ...
    "result": 
    {
        ...
        "total_weight_units": "POUND",
        "total_qty": "2.0000",
        "shipped_weight": "13.2300",
        "shipped_weight_units": "POUND",
        "source": "123",
        ...
        "packages": [
            {
                ...
                "weight_units": "POUND",
                "billable_weight": "14",
                "billable_weight_units": "POUND",
                "dimensional_weight_divisor": "139",
                "dimensional_weight_divisor_units": "in^3/lb",
                "dimensional_weight": "14",
                "dimensional_weight_units": "POUND",
                "dimensions": {
                    "length": "16.000",
                    "width": "12.000",
                    "height": "8.000"
...
shipment.update
<code>(string $shipment, object $shipmentData)</code>
</h1>
...
<tbody>
    ...
    <tr>
        <th>total_weight_units</th>
        <td>
            <pre><code>{ "total_weight_units": "POUND" }</code></pre>
    ...
    <tr>
        <th>shipped_weight_units</th>
        <td>
            <pre><code>{ "shipped_weight_units": "POUND" }</code></pre>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <pre><code>{ "weight": "12.0000" }</code></pre>
            The "Weight" property. See: <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.
        </td>
    </tr>
    <tr>
        <th>qty</th>
...
<tr>
    ...
    <td>
        ...
        The unit of measure used for <code>weight</code>.
    </td>
</tr>
<tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <pre><code>{ "weight_units": "POUND" }</code></pre>
            The unit of measure of the <code>weight</code>. See: <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.
        </td>
    </tr>
</tbody>
</table>
