...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            Weight Unit of the Order Item <code>weight</code> property. See <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.
        </td>
    </tr>
    <tr>
        <th>row_weight</th>
    ...
    <tr>
        <th>row_weight_units</th>
        <td>
            <pre><code>{ "row_weight_units" : "POUND" }</code></pre>
            Weight Unit of the Order Item <code>row_weight</code> property. See <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.
        </td>
    </tr>
    <tr>
        <th>qty_ordered</th>
...
<tr>
    ...
    <td>
        <pre><code>{ "weight_units" : "POUND" }</code></pre>
        The unit of measure used for the <code>weight</code> property. See: <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.
    </td>
</tr>
<tr>
...
<tr>
    <th>billable_weight_units</th>
    <td>
        <pre><code>{ "billable_weight_units" : "POUND" }</code></pre>
...
<tr>
    <th>dimensional_weight_divisor_units</th>
    <td>
        <pre><code>{ "dimensional_weight_divisor_units": "in^3/lb" }</code></pre>
...
<tr>
    <th>dimensional_weight_units</th>
    <td>
        <pre><code>{ "dimensional_weight_units": "POUND" }</code></pre>
