...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Weight" property. The units are the same as the order item's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
        <th>row_weight</th>
        <td>
            ...
            Total order item weight. The units are the same as the order item's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
        <th>weight_unit</th>
