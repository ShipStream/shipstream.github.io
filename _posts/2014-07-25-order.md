...
signature_required
: Values can be `none`, `any`, `adult`, <abbr title="Supported by FedEx">`indirect`</abbr>&ast;, or <abbr title="Supported by FedEx">`default`</abbr>&ast;.<br />
&ast;Supported by FedEx.<br />
