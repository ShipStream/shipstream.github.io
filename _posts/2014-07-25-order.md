...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Weight" property. The units are the same as the order's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
        <th>row_weight</th>
        <td>
            ...
            Total order item weight. The units are the same as the order's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
        <th>qty_ordered</th>
