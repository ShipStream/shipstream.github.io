...
<tr>
    ...
    <td>
        ...
        The "Shipment Status" property. Allowed values: new, picking, picked, packing, packing_exception, packed, shipped, canceled, voided.
    </td>
</tr>
<tr>
    <th>carrier</th>
...
<ul>
    <li>To find out what fields are available see <a href="/doc/order-custom-field.html" title="Order Custom Fields">Order Custom Fields</a> — <code>order_custom_field.list</code></li>
</ul>
