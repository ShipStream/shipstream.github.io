...
<tbody>
    ...
    <tr>
        <th>weight_unit</th>
        <td>Weight Unit. See <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.</td>
    </tr>
    <tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Weight" property. The units are the same as the order items's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
        <th>row_weight</th>
        <td>
            ...
            Total order item weight. The units are the same as the order items's <code>weight_unit</code> property.
        </td>
    </tr>
    <tr>
        <th>weight_unit</th>
        <td>
            ...
            Weight Unit of the Order Item <code>weight</code> and <code>row_weight</code> properties. See <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.
        </td>
    </tr>
    <tr>
        <th>qty_ordered</th>
...
<tr>
    ...
    <td>
        ...
        The weight of the package.  The units are the same as the order's <code>weight_unit</code> property.
    </td>
</tr>
<tr>
    <th>weight_unit</th>
    <td>
        <pre><code>{ "weight_unit" : "lb" }</code></pre>
        The unit of measure used for weight. See: <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>.
    </td>
</tr>
<tr>
    ...
    <td>
        ...
        The billable weight of the package.  The units are the same as the order's <code>weight_unit</code> property.
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        ...
        The dimensional weight of the package. The units are the same as the order's <code>weight_unit</code> property.
    </td>
</tr>
<tr>
    <th>dimensions</th>
...
<tr>
    ...
    <td>
        ...
        The unit of measure used for dimensional measurement. See: <a href="/doc/units-of-measure.html#length" title="Length Units">Length Units</a>.
    </td>
</tr>
<tr>
    <th>tracking</th>
