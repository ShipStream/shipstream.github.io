...
signature_required
: Values can be `none`, `any`, `adult`, <abbr title="Supported by FedEx">`indirect`</abbr><sup>&ast;</sup>, or <abbr title="Supported by FedEx">`default`</abbr><sup>&ast;</sup>.<br />
<sup>&ast;</sup>Supported by FedEx.<br />
