...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Valid Containers" property. A list of SKUs of valid containers, separated by "|".
        </td>
    </tr>
    <tr>
        <th>special_supplies</th>
        <td>
            <pre><code>{ "special_supplies" : "suppliessku1|suppliessku2" }</code></pre>
            The "Special Supplies" property. A list of SKUs of special packaging supplies, separated by "|".
        </td>
    </tr>
    <tr>
        <th>special_other</th>
        <td>
            ...
            The "Other Special Features" property. A list of SKUs of other special packaging features, separated by "|".
        </td>
    </tr>
    <tr>
        <th>unit_qty</th>
