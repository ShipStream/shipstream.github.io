 ...
 * [Put-Away Item](#putaway_item_properties)
...
<h3 id="putaway_item_properties">
    Put-Away Item Properties
</h3>

<table class="table-striped">
<tbody>
    <tr>
        <th>putaway_item_id</th>
        <td>
            <pre><code>{ "putaway_item_id" : 2 }</code></pre>
            The internal putaway item ID.
        </td>
    </tr>
    <tr>
        <th>putaway_id</th>
        <td>
            <pre><code>{ "putaway_id" : 3 }</code></pre>
            The internal putaway ID.
        </td>
    </tr>
    <tr>
        <th>lot_id</th>
        <td>
            <pre><code>{ "lot_id" : 5 }</code></pre>
            The internal lot ID.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <th>qty_putaway</th>
        <td>
            <pre><code>{ "qty_putaway" : 2 }</code></pre>
            The "Quantity Put-Away" property.
        </td>
    </tr>
</tbody>
</table>
