...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Total Container Weight" property. The unit is the same as the delivery's <code>weight_unit</code>.
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            The "Total Product Weight" property. The unit is the same as the delivery's <code>weight_unit</code>.
        </td>
    </tr>
    <tr>
        <th>weight_unit</th>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <pre><code>{ "weight_unit" : "lb" }</code></pre>
            The unit of measure used for the package weight. See: <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>. 
        </td>
    </tr>
    <tr>
        <th>dimensions</th>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Tare Weight" property. The units are the same as the delivery's <code>weight_unit</code>, not the 
            container's <code>weight_unit</code>.
        </td>
    </tr>
    <tr>
        <th>weight</th>
    ...
    <tr>
        ...
        <td>
            <pre><code>{ "weight_unit" : "lb" }</code></pre>
            The unit of measurement of the <code>weight</code> property. See: <a href="/doc/units-of-measure.html#weight" title="Weight Units">Weight Units</a>. 
        </td>
    </tr>
    <tr>
        <th>weighed_at</th>
